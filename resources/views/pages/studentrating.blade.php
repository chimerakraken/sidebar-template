...
<div class="px-5 sm:p-10 pt-28 lg:pt-32 lg:px-32 " x-data="{ openmodal: false, titlemodal: ''}">
    <div class=" px-5 mb-10 lg:mb-7">
    <h3 class="text-lg font-medium leading-6 text-lime-900">Choose the teacher you want to rate</h3>
            <p class="mt-1 text-sm text-lime-900">
                Get started by tapping the 'rate' button, your honest answers will benefit both your instructors and you because this information will hopefully help them improve their weak points and maintain their strong points.
            </p>   
     </div>   
    <div class="grid grid-cols-5 gap-8 p-5 lg:p-20 pt-10">
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            <div align="center">
                <div class=" bg-gray-50 pt-10 pb-5">
                    <img class="rounded-full h-48 w-48 filter" :class="[hovered === true ? 'grayscale-0' : 'grayscale']" src="https://images.unsplash.com/photo-1602152914969-d8a2e174ff08?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"  alt="">
                </div>
            </div>
            <div class="pt-5" align="center">
                <span x-id="teachername1" x-data="{ name: $el.innerHTML }" class="text-lg font-semibold text-lime-900">Alima Hutchinson</span><br>
        ...
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            <div align="center">
                <div class=" bg-gray-50 pt-10 pb-5">
                    <img class="rounded-full h-48 w-48 filter" :class="[hovered === true ? 'grayscale-0' : 'grayscale']" src="https://images.unsplash.com/photo-1596724105459-8a04323a507f?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=634&q=80"  alt="">
                </div>
            </div>
            <div class="pt-5" align="center">
                <span x-id="teachername2" x-data="{ name: $el.innerHTML }" class="text-lg font-semibold text-lime-900" >Dominika Huerta</span><br>
                <span class="text-sm text-lime-900">IT136: PROJECT MANAGEMENT</span>
            </div>
            <div class="grid grid-cols-2 gap-3 lg:gap-5 sm:gap-3 mb-6 mt-7 px-7">
                <div class="col-span-2 sm:col-span-2 lg:col-span-1" align="center">
        ...
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            <div align="center">
                <div class=" bg-gray-50 pt-10 pb-5">
                    <img class="rounded-full h-48 w-48 filter" src="https://images.unsplash.com/photo-1549237511-6b64e006ce65?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=634&q=80"  alt="">
                </div>
            </div>
            <div class="pt-5" align="center">
                ...
                <span class="relative" x-show.transition.origin.top="tooltip">
                    ...
                    <span  style="width: 6rem" class="absolute top-0 z-10 p-1 -mt-1 text-sm leading-tight  transform -translate-x-1/2 -translate-y-full bg-lime-500 text-lime-50 rounded-lg shadow-lg">
                       Evaluated 
        ...
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            ...
            <div class="pt-5" align="center">
                <span x-id="teachername3" x-data="{ name: $el.innerHTML, tooltip: false }" class="text-lg font-semibold text-lime-900">Hareem Richards
                <svg x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="w-5 h-5 inline-block -mt-1 fill-current text-lime-600 cursor-pointer" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                <span class="relative" x-show.transition.origin.top="tooltip">
        ...
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            <div align="center">
                <div class=" bg-gray-50 pt-10 pb-5">
                    <img class="rounded-full h-48 w-48 filter" :class="[hovered === true ? 'grayscale-0' : 'grayscale']" src="https://images.unsplash.com/photo-1581625991440-291cfd5c171c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDR8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60"  alt="">
                </div>
            </div>
            <div class="pt-5" align="center">
                <span x-id="teachername1" x-data="{ name: $el.innerHTML }" class="text-lg font-semibold text-lime-900">June Ewing</span><br>
                <span class="text-sm text-lime-900">IT136: PROJECT MANAGEMENT</span>
            </div>
            <div class="grid grid-cols-2 gap-3 lg:gap-5 sm:gap-3 mb-6 mt-7 px-7">
                <div class="col-span-2 sm:col-span-2 lg:col-span-1" align="center">
        ...
        <div x-data="{ hovered: false, expanded : false }" @click.away="expanded = false" x-on:mouseover="hovered = true" x-on:mouseleave="hovered = false" class=" overflow-hidden relative col-span-5 md:col-span-2 lg:col-span-1 rounded shadow transition-all transform hover:scale-95 ease-in-out duration-300 scale-90">
            <div align="center">
                <div class=" bg-gray-50 pt-10 pb-5">
                    <img class="rounded-full h-48 w-48 filter" :class="[hovered === true ? 'grayscale-0' : 'grayscale']" src="https://images.unsplash.com/photo-1621604475054-42d05cbc1b9d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80"  alt="">
                </div>
            </div>
            <div class="pt-5" align="center">
                <span x-id="teachername1" x-data="{ name: $el.innerHTML }" class="text-lg font-semibold text-lime-900">Myron Eastwood</span><br>
                <span class="text-sm text-lime-900">IT136: PROJECT MANAGEMENT</span>
            </div>
            <div class="grid grid-cols-2 gap-3 lg:gap-5 sm:gap-3 mb-6 mt-7 px-7">
                <div class="col-span-2 sm:col-span-2 lg:col-span-1" align="center">
    ...
    <div @keydown.window.escape="openmodal = false" x-show="openmodal" class="fixed z-30 inset-0 overflow-y-auto" aria-labelledby="modal-title" x-ref="dialog" aria-modal="true" style="display: none;">
        ...
        <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">​</span>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="button" class=" box-border w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-lime-600 text-base font-medium text-white hover:bg-lime-700 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-lime-500 sm:ml-3 sm:w-auto sm:text-sm" @click=" openmodal = false">
                Rate now
                </button>
                <button type="button" class=" box-border mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm" @click=" openmodal = false">
                Cancel
                </button>
            </div>
            </div>
